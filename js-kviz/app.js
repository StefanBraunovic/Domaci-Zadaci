...
const pitanja = [
    ...
    },
    {
      ...
      pitanje: "Kako se zove prvi čovjek koji je sletio na Mjesec?",
      odgovori: {
        a: "Kakarot",
        b: "Nil Armstrong",
        c: "Salvador Dali"
    ...
    {
      pitanje: "Ko je frontman benda <em>Metallica</em>? ",
      odgovori: {
        a: "James Hetfield",
        b: "Dave Mustain",
        c: "Kirk Hammett"
    ...
    {
      pitanje: "Kako se zove poslednje dijelo koje je komponovao  <em>Mozart</em> ",
      odgovori: {
        a: "Symphony No.41 In C, K551 – Jupiter",
        b: "Quintet In A For Clarinet And Strings, K581",
...
function prikaziRezultat(){
  ...
  const svapitanja = document.querySelectorAll('.pitanje');
  ...
  pitanja.forEach(function(trenutnoPitanje, pitanjeInd){
    ...
    // const odgovori= Svapitanja[pitanjeInd]; 
    ...
    svapitanja[pitanjeInd].style.color='green';

}else{
  svapitanja[pitanjeInd].style.color='red';
}
});
...
const timer = setInterval(function(){
  if(preostaloVrijeme <= 0){
    ...
    document.getElementById("clock").innerHTML = preostaloVrijeme;
  }
  preostaloVrijeme -= 1;
}, 1000);
